...
class CrossPointSettings {
 ...
 public:
  ...
  enum LONG_PRESS_BUTTON_BEHAVIOR {
    ...
    LONG_PRESS_TOGGLE_DARK_MODE = 5,
    LONG_PRESS_FORCE_REFRESH = 6,
    LONG_PRESS_READING_STATS = 7,
    LONG_PRESS_TOGGLE_BOOKMARK = 8,
    LONG_PRESS_FILE_TRANSFER = 9,
  ...
  uint8_t sideButtonFollowOrientation = 0;
