...
inline const std::array<ShortcutDefinition, 23>& getShortcutDefinitions() {
  static const std::array<ShortcutDefinition, 23> definitions = {
      ...
      ShortcutDefinition{ShortcutId::IfFound, StrId::STR_IF_FOUND_RETURN_ME, StrId::STR_IF_FOUND_APP_DESC,
                         UIIcon::GpsFound, &CrossPointSettings::ifFoundShortcut,
                         &CrossPointSettings::ifFoundShortcutOrder,
      ...
      ShortcutDefinition{ShortcutId::Bookmarks, StrId::STR_HIGHLIGHTS, StrId::STR_HIGHLIGHTS_APP_DESC,
                         UIIcon::Book, &CrossPointSettings::bookmarksShortcut,
                         &CrossPointSettings::bookmarksShortcutOrder,
                         &CrossPointSettings::bookmarksShortcutVisible},
      ShortcutDefinition{ShortcutId::Favorites, StrId::STR_FAVORITES, StrId::STR_FAVORITES_APP_DESC,
                         UIIcon::Heart, &CrossPointSettings::favoritesShortcut,
                         &CrossPointSettings::favoritesShortcutOrder,
                         &CrossPointSettings::favoritesShortcutVisible},
      ShortcutDefinition{ShortcutId::Flashcards, StrId::STR_FLASHCARDS, StrId::STR_FLASHCARDS_APP_DESC,
                         UIIcon::FlashcardQuiz, &CrossPointSettings::flashcardsShortcut,
                         &CrossPointSettings::flashcardsShortcutOrder,
                         &CrossPointSettings::flashcardsShortcutVisible},
      ShortcutDefinition{ShortcutId::Dictionary, StrId::STR_DICTIONARY, StrId::STR_DICTIONARY_APP_DESC,
                         UIIcon::Dictionary2, &CrossPointSettings::dictionaryShortcut,
                         &CrossPointSettings::dictionaryShortcutOrder,
      ...
      ShortcutDefinition{ShortcutId::Sleep, StrId::STR_SLEEP, StrId::STR_SLEEP_APP_DESC,
                         UIIcon::SleepMode, &CrossPointSettings::sleepShortcut,
      ...
      ShortcutDefinition{ShortcutId::Library, StrId::STR_MENU_LIBRARY, StrId::STR_LIBRARY_APP_DESC,
                         UIIcon::LibraryNew, &CrossPointSettings::libraryShortcut,
                         &CrossPointSettings::libraryShortcutOrder,
