...
inline const std::array<ShortcutDefinition, 19>& getShortcutDefinitions() {
  static const std::array<ShortcutDefinition, 19> definitions = {
      ...
      ShortcutDefinition{ShortcutId::Achievements, StrId::STR_ACHIEVEMENTS, StrId::STR_ACHIEVEMENTS_APP_DESC,
                         UIIcon::GoalsMedal, &CrossPointSettings::achievementsShortcut,
                         &CrossPointSettings::achievementsShortcutOrder, &CrossPointSettings::achievementsShortcutVisible},
      ShortcutDefinition{ShortcutId::IfFound, StrId::STR_IF_FOUND_RETURN_ME, StrId::STR_IF_FOUND_APP_DESC, UIIcon::LostDevice,
      ...
      ShortcutDefinition{ShortcutId::Dictionary, StrId::STR_DICTIONARY, StrId::STR_DICTIONARY_APP_DESC, UIIcon::Dictionary,
      ...
      ShortcutDefinition{ShortcutId::OpdsBrowser, StrId::STR_OPDS_BROWSER, StrId::STR_NONE_OPT, UIIcon::OpdsBrowser,
