...
static std::string getSandboxDir() { return "/custom/" + g_pluginName + "_data/"; }
...
static int l_lcd_drawWrappedText(lua_State* L) {
  ...
  const std::vector<std::string> lines = g_renderer->wrappedText(UI_10_FONT_ID, text, maxWidth, maxLines);
...
static int l_input_isPressed(lua_State* L) {
  ...
  } btnMap[] = {{"back", MappedInputManager::Button::Back},       {"ok", MappedInputManager::Button::Confirm},
                {"confirm", MappedInputManager::Button::Confirm}, {"left", MappedInputManager::Button::Left},
                {"right", MappedInputManager::Button::Right},     {"up", MappedInputManager::Button::Up},
                {"down", MappedInputManager::Button::Down},       {"power", MappedInputManager::Button::Power},
...
static luaL_Reg lcd_funcs[] = {{"fillScreen", l_lcd_fillScreen},
                               {"clear", l_lcd_clear},
...
static luaL_Reg fs_funcs[] = {{"readFile", l_fs_readFile},     {"writeFile", l_fs_writeFile},
                              {"appendFile", l_fs_appendFile}, {"exists", l_fs_exists},
                              {"listDir", l_fs_listDir},       {"remove", l_fs_remove},
                              {"mkdir", l_fs_mkdir},           {"rename", l_fs_rename},
                              {"getDataDir", l_fs_getDataDir}, {nullptr, nullptr}};

static luaL_Reg input_funcs[] = {{"isPressed", l_input_isPressed},
                                 {"wasPressed", l_input_wasPressed},
                                 {"waitButton", l_input_waitButton},
                                 {"getHeldTime", l_input_getHeldTime},
                                 {nullptr, nullptr}};

static luaL_Reg sys_funcs[] = {{"getTime", l_sys_getTime},
...
static luaL_Reg str_funcs[] = {
    {"wrapText", l_str_wrapText}, {"truncate", l_str_truncate}, {"len", l_str_len}, {"upper", l_str_upper},
    {"lower", l_str_lower},       {"format", l_str_format},     {nullptr, nullptr}};
