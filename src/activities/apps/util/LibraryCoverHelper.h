...
class LibraryCoverHelper {
 public:
  ...
  static void deletePageCovers(int gridsPerPage, const LibraryIndex::BookRef* pageCache,
                               int coverWidth, int coverHeight);
  static void deleteAllLibraryCovers(int coverWidth, int coverHeight);
  static bool writeTextFallbackCover(GfxRenderer& renderer, const std::string& path,
                                     int coverWidth, int coverHeight);
  static bool generatePageCover(GfxRenderer& renderer, const std::string& path,
                                int coverWidth, int coverHeight);
};
