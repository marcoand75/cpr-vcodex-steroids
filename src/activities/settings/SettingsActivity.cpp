      ...
      SettingInfo::Toggle(StrId::STR_SIDE_BTN_FOLLOW_ORIENTATION, &CrossPointSettings::sideButtonFollowOrientation),
        SettingInfo::Enum(StrId::STR_LONG_PRESS_BEHAVIOR, &CrossPointSettings::longPressButtonBehavior,
                          {StrId::STR_LONG_PRESS_BEHAVIOR_OFF, StrId::STR_LONG_PRESS_BEHAVIOR_SKIP,
                           ...
                           StrId::STR_LONG_PRESS_BEHAVIOR_CLIPPING, StrId::STR_LONG_PRESS_BEHAVIOR_TOGGLE_DARK_MODE,
                           StrId::STR_LONG_PRESS_BEHAVIOR_FORCE_REFRESH, StrId::STR_LONG_PRESS_BEHAVIOR_READING_STATS,
                           StrId::STR_LONG_PRESS_BEHAVIOR_TOGGLE_BOOKMARK, StrId::STR_LONG_PRESS_BEHAVIOR_FILE_TRANSFER}),
