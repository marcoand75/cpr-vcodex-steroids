...
bool IndexCacheManager::hasMixedIndex() { return g_mixedData != nullptr && g_mixedCount > 0; }
...
int IndexCacheManager::mixedIndexTotal() { return g_mixedCount; }

const LibraryIndex::IndexRec* IndexCacheManager::mixedIndexData() { return g_mixedData; }
...
bool IndexCacheManager::hasCollectionsIndex() { return g_collectionsData != nullptr && g_collectionsCount > 0; }
...
int IndexCacheManager::collectionsIndexTotal() { return g_collectionsCount; }

const LibraryIndex::CollectionIndexRec* IndexCacheManager::collectionsIndexData() { return g_collectionsData; }
...
size_t IndexCacheManager::totalCachedBytes() { return mixedIndexBytes() + collectionsIndexBytes(); }
