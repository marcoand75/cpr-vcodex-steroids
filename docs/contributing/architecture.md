...
```mermaid
graph TD
    A[Hardware: ESP32-C3 + SD + E-ink + Buttons] --> B[freeink-sdk + vCodex HAL]
...
- `freeink-sdk/`: hardware SDK submodule (board profiles, panel detection, display, input, storage, battery and power)
