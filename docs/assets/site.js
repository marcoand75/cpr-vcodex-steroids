(() => {
  ...
  const messages = {
    en: {
      ...
      homeTitle: "CPR-vCodex Steroids Tools",
      homeSubtitle: "Small browser tools for CPR-vCodex Steroids. Everything runs locally in your browser.",
      latestFirmware: "Latest firmware: 1.5.0.23-CPR-vCodex Steroids-steroids",
      homeFlash: "Auto Flash",
      homeStats: "Reading Stats Editor",
      homeTools: "Tools",
      homeGithub: "GitHub",
      toolsTitle: "Tools",
      toolsSubtitle: "Useful browser tools for CPR-vCodex Steroids plus external utilities that fit the Xteink workflow.",
      toolsStatsTitle: "CPR-vCodex Steroids Reading Stats Editor",
      ...
      flashTitle: "Flash CPR-vCodex Steroids",
      flashSubtitle: "Install the latest CPR-vCodex Steroids firmware on your Xteink X3 or X4 from Chrome or Edge using Web Serial. It writes the inactive app partition and then switches boot to it.",
      ...
      flashButton: "Flash CPR-vCodex Steroids Firmware",
      flashButtonForDevice: "Flash CPR-vCodex Steroids Firmware for {device}",
      flashing: "Flashing...",
      ...
      partitionUnsupportedX4Pro: "Xteink X4 Pro detected. CPR-vCodex Steroids does not currently publish an ESP32-S3 X4 Pro firmware. Nothing was written.",
      unknownFlashError: "Unknown flash error",
      flashComplete: "Flash complete. The device should reboot into CPR-vCodex Steroids.",
    ...
    es: {
      ...
      homeTitle: "Herramientas CPR-vCodex Steroids",
      homeSubtitle: "Pequeñas herramientas de navegador para CPR-vCodex Steroids. Todo se ejecuta localmente en tu navegador.",
      latestFirmware: "Último firmware: 1.5.0.23-CPR-vCodex Steroids-steroids",
      homeFlash: "Auto Flash",
      homeStats: "Editor de estadísticas",
      homeTools: "Herramientas",
      homeGithub: "GitHub",
      toolsTitle: "Herramientas",
      toolsSubtitle: "Herramientas de navegador para CPR-vCodex Steroids y utilidades externas útiles para el flujo de trabajo Xteink.",
      toolsStatsTitle: "Editor de estadísticas de lectura CPR-vCodex Steroids",
      ...
      flashTitle: "Flashear CPR-vCodex Steroids",
      flashSubtitle: "Instala el último firmware CPR-vCodex Steroids en tu Xteink X3 o X4 desde Chrome o Edge usando Web Serial. Escribe la partición de app inactiva y luego arranca desde ella.",
      ...
      flashButton: "Flashear firmware CPR-vCodex Steroids",
      flashButtonForDevice: "Flashear firmware CPR-vCodex Steroids para {device}",
      flashing: "Flasheando...",
      ...
      flashComplete: "Flasheo completado. El dispositivo debería reiniciar en CPR-vCodex Steroids.",
  ...
  Object.assign(messages, {
    ca: {
      ...
      homeSubtitle: "Petites eines de navegador per a CPR-vCodex Steroids. Tot s'executa localment al navegador.", latestFirmware: "Últim firmware: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Editor d'estadístiques",
      flashEyebrow: "Instal·lador des del navegador", flashTitle: "Flasheja CPR-vCodex Steroids", flashSubtitle: "Instal·la l'últim firmware CPR-vCodex Steroids al teu Xteink X3/X4 des de Chrome o Edge amb Web Serial. Escriu la partició d'app inactiva i després hi canvia l'arrencada.",
      ...
      flashButton: "Flasheja el firmware CPR-vCodex Steroids", flashing: "Flashejant...", readyStatus: "A punt. En prémer Flash s'obrirà el selector de port sèrie del navegador.", choosePort: "Tria el port sèrie ESP32-C3 a l'avís del navegador.",
      ...
      flashComplete: "Flasheig completat. El dispositiu hauria de reiniciar amb CPR-vCodex Steroids.", flashStopped: "Flasheig aturat. Revisa el missatge anterior abans de tornar-ho a intentar.", downloadBin: "Descarrega .bin", communityFlasher: "Flasher comunitari",
    ...
    fr: {
      ...
      homeSubtitle: "Petits outils de navigateur pour CPR-vCodex Steroids. Tout s'exécute localement dans votre navigateur.", latestFirmware: "Dernier firmware : 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Éditeur de statistiques",
      flashEyebrow: "Installateur dans le navigateur", flashTitle: "Flasher CPR-vCodex Steroids", flashSubtitle: "Installez le dernier firmware CPR-vCodex Steroids sur votre Xteink X3/X4 depuis Chrome ou Edge avec Web Serial. Il écrit la partition d'application inactive puis bascule le démarrage dessus.",
      ...
      flashButton: "Flasher le firmware CPR-vCodex Steroids", flashing: "Flash en cours...", readyStatus: "Prêt. Cliquer sur Flash ouvrira le sélecteur de port série du navigateur.", choosePort: "Choisissez le port série ESP32-C3 dans la fenêtre du navigateur.",
      ...
      flashComplete: "Flash terminé. L'appareil devrait redémarrer sur CPR-vCodex Steroids.", flashStopped: "Flash arrêté. Vérifiez le message ci-dessus avant de réessayer.", downloadBin: "Télécharger .bin", communityFlasher: "Flasher communautaire",
    ...
    de: {
      ...
      homeSubtitle: "Kleine Browser-Tools für CPR-vCodex Steroids. Alles läuft lokal in Ihrem Browser.", latestFirmware: "Neueste Firmware: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Statistik-Editor",
      flashEyebrow: "Browserbasierter Installer", flashTitle: "CPR-vCodex Steroids flashen", flashSubtitle: "Installieren Sie die neueste CPR-vCodex Steroids-Firmware auf Ihrem Xteink X3/X4 mit Chrome oder Edge und Web Serial. Die inaktive App-Partition wird beschrieben und anschließend als Bootziel gesetzt.",
      ...
      flashButton: "CPR-vCodex Steroids-Firmware flashen", flashing: "Flashe...", readyStatus: "Bereit. Ein Klick auf Flash öffnet die serielle Geräteauswahl des Browsers.", choosePort: "Wählen Sie im Browserdialog den ESP32-C3-Seriellport.",
      ...
      flashComplete: "Flash abgeschlossen. Das Gerät sollte in CPR-vCodex Steroids neu starten.", flashStopped: "Flash gestoppt. Prüfen Sie die Meldung oben, bevor Sie es erneut versuchen.", downloadBin: ".bin herunterladen", communityFlasher: "Community-Flasher",
    ...
    it: {
      ...
      homeSubtitle: "Piccoli strumenti browser per CPR-vCodex Steroids. Tutto viene eseguito localmente nel browser.", latestFirmware: "Firmware più recente: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Editor statistiche",
      flashEyebrow: "Installer nel browser", flashTitle: "Flash CPR-vCodex Steroids", flashSubtitle: "Installa l'ultimo firmware CPR-vCodex Steroids sul tuo Xteink X3/X4 da Chrome o Edge usando Web Serial. Scrive la partizione app inattiva e poi avvia da quella.",
      ...
      flashButton: "Flash firmware CPR-vCodex Steroids", flashing: "Flash in corso...", readyStatus: "Pronto. Premendo Flash si aprirà il selettore della porta seriale del browser.", choosePort: "Scegli la porta seriale ESP32-C3 nel prompt del browser.",
      ...
      flashComplete: "Flash completato. Il dispositivo dovrebbe riavviarsi in CPR-vCodex Steroids.", flashStopped: "Flash interrotto. Controlla il messaggio sopra prima di riprovare.", downloadBin: "Scarica .bin", communityFlasher: "Flasher community",
    ...
    pt: {
      ...
      homeSubtitle: "Pequenas ferramentas de navegador para CPR-vCodex Steroids. Tudo roda localmente no seu navegador.", latestFirmware: "Firmware mais recente: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Editor de estatísticas",
      flashEyebrow: "Instalador no navegador", flashTitle: "Gravar CPR-vCodex Steroids", flashSubtitle: "Instale o firmware CPR-vCodex Steroids mais recente no seu Xteink X3/X4 pelo Chrome ou Edge usando Web Serial. Ele grava a partição de app inativa e depois muda o boot para ela.",
      ...
      flashButton: "Gravar firmware CPR-vCodex Steroids", flashing: "Gravando...", readyStatus: "Pronto. Clicar em Flash abrirá o seletor de dispositivo serial do navegador.", choosePort: "Escolha a porta serial ESP32-C3 no prompt do navegador.",
      ...
      flashComplete: "Flash concluído. O dispositivo deve reiniciar no CPR-vCodex Steroids.", flashStopped: "Flash interrompido. Verifique a mensagem acima antes de tentar de novo.", downloadBin: "Baixar .bin", communityFlasher: "Flasher da comunidade",
    ...
    nl: {
      ...
      homeSubtitle: "Kleine browsertools voor CPR-vCodex Steroids. Alles draait lokaal in je browser.", latestFirmware: "Nieuwste firmware: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Statistiekeditor",
      flashEyebrow: "Browserinstallatie", flashTitle: "CPR-vCodex Steroids flashen", flashSubtitle: "Installeer de nieuwste CPR-vCodex Steroids-firmware op je Xteink X3/X4 vanuit Chrome of Edge met Web Serial. De inactieve app-partitie wordt geschreven en daarna als bootdoel ingesteld.",
      ...
      flashButton: "CPR-vCodex Steroids-firmware flashen", flashing: "Flashen...", readyStatus: "Klaar. Klik op Flash om de seriële apparaatkiezer van de browser te openen.", choosePort: "Kies de ESP32-C3 seriële poort in de browsermelding.",
      ...
      flashComplete: "Flash voltooid. Het apparaat zou in CPR-vCodex Steroids moeten herstarten.", flashStopped: "Flash gestopt. Controleer het bericht hierboven voordat je opnieuw probeert.", downloadBin: ".bin downloaden", communityFlasher: "Communityflasher",
  ...
  Object.assign(messages, {
    be: {
      navHome: "Галоўная", navStats: "Рэдактар статыстыкі", darkMode: "Цёмны рэжым", lightMode: "Светлы рэжым", homeSubtitle: "Невялікія браузерныя інструменты для CPR-vCodex Steroids. Усё працуе лакальна ў вашым браузеры.", latestFirmware: "Апошняя прашыўка: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Рэдактар статыстыкі",
      flashEyebrow: "Усталёўшчык у браузеры", flashTitle: "Прашыць CPR-vCodex Steroids", flashSubtitle: "Усталюйце апошнюю прашыўку CPR-vCodex Steroids на Xteink X3/X4 з Chrome або Edge праз Web Serial. Яна запісвае неактыўны app-раздзел і пераключае загрузку на яго.",
      ...
      latestPackage: "Апошні пакет прашыўкі", flashWarning: "Выкарыстоўвайце на сваю рызыку. Прашыўка кастомнага firmware можа не атрымацца, калі кабель адключыцца або прылада страціць сілкаванне.", unsupported: "Web Serial недаступны ў гэтым браузеры. Выкарыстоўвайце Chrome або Edge на камп'ютары або спампуйце binary уручную.", flashButton: "Прашыць CPR-vCodex Steroids", flashing: "Прашыўка...", readyStatus: "Гатова. Націск Flash адкрые выбар серыйнай прылады ў браузеры.", choosePort: "Выберыце серыйны порт ESP32-C3 у акне браузера.", openingConnection: "Адкрыццё злучэння з bootloader...", partitionOk: "Знойдзена стандартная OTA табліца раздзелаў CrossPoint/Xteink.", fetchingFirmware: "Спампоўваецца пакет прашыўкі...",
      firmwareDownloadFailed: "Не ўдалося спампаваць прашыўку", firmwareTooLarge: "Прашыўка занадта вялікая для app-раздзела: {size}.", firmwareTooSmall: "Прашыўка выглядае занадта малой. Падазроны файл не будзе прашыты.", currentBootTarget: "Бягучая загрузка: {current}. Наступная мэта прашыўкі: {target}.", writingOffset: "Запіс у offset {offset}...", partitionUnexpected: "Нечаканая канфігурацыя раздзелаў. Гэты браузерны flasher падтрымлівае толькі стандартную OTA табліцу CrossPoint/Xteink.", unknownFlashError: "Невядомая памылка прашыўкі", flashComplete: "Прашыўка завершана. Прылада павінна запусціцца ў CPR-vCodex Steroids.", flashStopped: "Прашыўка спынена. Праверце паведамленне вышэй перад паўторнай спробай.", downloadBin: "Спампаваць .bin", communityFlasher: "Community flasher", flashNote: "Аўтаматычны flasher выкарыстоўвае копію прашыўкі, апублікаваную з гэтай старонкай. Кнопка спампоўкі выкарыстоўвае asset з GitHub release.", manualTitle: "Ручная прашыўка праз PlatformIO", manualText: "Для dev-зборак клануйце repo, задайце upload port і выкарыстоўвайце PlatformIO.", stepPending: "Чакае", stepRunning: "Выконваецца", stepDone: "Гатова", stepFailed: "Памылка", stepConnect: "Падключыць прыладу", stepPartition: "Праверыць табліцу раздзелаў", stepDownload: "Спампаваць прашыўку", stepReadOtadata: "Прачытаць otadata", stepFlashApp: "Прашыць app-раздзел", stepFlashOtadata: "Прашыць otadata", stepReset: "Перазапусціць прыладу"
    },
    kk: {
      navHome: "Басты бет", navStats: "Статистика редакторы", darkMode: "Қараңғы режим", lightMode: "Жарық режим", homeSubtitle: "CPR-vCodex Steroids үшін шағын браузер құралдары. Барлығы браузерде жергілікті орындалады.", latestFirmware: "Соңғы firmware: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Статистика редакторы",
      flashEyebrow: "Браузердегі орнатқыш", flashTitle: "CPR-vCodex Steroids flash", flashSubtitle: "Соңғы CPR-vCodex Steroids firmware нұсқасын Xteink X3/X4 құрылғысына Chrome немесе Edge арқылы Web Serial көмегімен орнатыңыз. Ол белсенді емес app бөлімін жазады және boot-ты соған ауыстырады.",
  ...
  Object.assign(messages, {
    cs: {
      ...
      latestPackage: "Nejnovější balíček firmwaru", flashWarning: "Použití na vlastní riziko. Flash vlastního firmwaru může selhat, pokud se odpojí kabel nebo zařízení ztratí napájení.", unsupported: "Web Serial není v tomto prohlížeči dostupný. Použijte Chrome nebo Edge na desktopu, nebo stáhněte binárku ručně.", flashButton: "Flashovat firmware CPR-vCodex Steroids", flashing: "Flashování...", readyStatus: "Připraveno. Kliknutí na Flash otevře výběr sériového zařízení v prohlížeči.", choosePort: "Vyberte sériový port ESP32-C3 v dialogu prohlížeče.", openingConnection: "Otevírání spojení s bootloaderem...", partitionOk: "Nalezena výchozí OTA tabulka oddílů CrossPoint/Xteink.", fetchingFirmware: "Stahování balíčku firmwaru...",
      firmwareDownloadFailed: "Stažení firmwaru selhalo", firmwareTooLarge: "Firmware je pro app oddíl příliš velký: {size}.", firmwareTooSmall: "Firmware vypadá příliš malý. Podezřelý soubor nebude flashován.", currentBootTarget: "Aktuální boot: {current}. Další cíl flashování: {target}.", writingOffset: "Zápis na offset {offset}...", partitionUnexpected: "Neočekávaná konfigurace oddílů. Tento prohlížečový flasher podporuje jen zařízení s výchozí OTA tabulkou CrossPoint/Xteink.", unknownFlashError: "Neznámá chyba flashování", flashComplete: "Flash dokončen. Zařízení by mělo nabootovat do CPR-vCodex Steroids.", flashStopped: "Flash zastaven. Před dalším pokusem zkontrolujte zprávu výše.", downloadBin: "Stáhnout .bin", communityFlasher: "Komunitní flasher", flashNote: "Automatický flasher používá kopii firmwaru publikovanou s touto stránkou. Tlačítko stažení používá asset z GitHub release.", manualTitle: "Ruční flash přes PlatformIO", manualText: "Pro vývojové buildy naklonujte repo, nastavte upload port a použijte PlatformIO.", stepPending: "Čeká", stepRunning: "Běží", stepDone: "Hotovo", stepFailed: "Chyba", stepConnect: "Připojit zařízení", stepPartition: "Ověřit tabulku oddílů", stepDownload: "Stáhnout firmware", stepReadOtadata: "Číst oddíl otadata", stepFlashApp: "Flashovat app oddíl", stepFlashOtadata: "Flashovat oddíl otadata", stepReset: "Resetovat zařízení"
    },
    da: {
      navHome: "Hjem", navStats: "Statistikeditor", darkMode: "Mørk tilstand", lightMode: "Lys tilstand", homeSubtitle: "Små browserværktøjer til CPR-vCodex Steroids. Alt kører lokalt i din browser.", latestFirmware: "Nyeste firmware: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Statistikeditor",
      flashEyebrow: "Browserbaseret installer", flashTitle: "Flash CPR-vCodex Steroids", flashSubtitle: "Installer den nyeste CPR-vCodex Steroids-firmware på din Xteink X3/X4 fra Chrome eller Edge med Web Serial. Den skriver den inaktive app-partition og skifter derefter boot til den.",
      ...
      latestPackage: "Nyeste firmwarepakke", flashWarning: "Brug på eget ansvar. Flash af brugerdefineret firmware kan fejle, hvis kablet afbrydes eller enheden mister strøm.", unsupported: "Web Serial er ikke tilgængelig i denne browser. Brug Chrome eller Edge på en desktop, eller download binærfilen manuelt.", flashButton: "Flash CPR-vCodex Steroids firmware", flashing: "Flasher...", readyStatus: "Klar. Klik på Flash for at åbne browserens serielle enhedsvælger.", choosePort: "Vælg ESP32-C3-serielporten i browserens prompt.", openingConnection: "Åbner bootloaderforbindelse...", partitionOk: "Standard CrossPoint/Xteink OTA-partitionstabel fundet.", fetchingFirmware: "Downloader firmwarepakke...",
      firmwareDownloadFailed: "Firmwaredownload mislykkedes", firmwareTooLarge: "Firmwaren er for stor til app-partitionen: {size}.", firmwareTooSmall: "Firmwaren ser for lille ud. Mistænkelig fil flashes ikke.", currentBootTarget: "Aktuel boot: {current}. Næste flashmål: {target}.", writingOffset: "Skriver til offset {offset}...", partitionUnexpected: "Uventet partitionskonfiguration. Denne browserflasher understøtter kun enheder med standard CrossPoint/Xteink OTA-tabellen.", unknownFlashError: "Ukendt flashfejl", flashComplete: "Flash fuldført. Enheden bør genstarte i CPR-vCodex Steroids.", flashStopped: "Flash stoppet. Tjek beskeden ovenfor før du prøver igen.", downloadBin: "Download .bin", communityFlasher: "Community-flasher", flashNote: "Den automatiske flasher bruger firmwarekopien publiceret med denne side. Downloadknappen bruger GitHub release-asset.", manualTitle: "Manuel PlatformIO flash", manualText: "For udviklingsbuilds, klon repoet, indstil uploadporten og brug PlatformIO.", stepPending: "Afventer", stepRunning: "Kører", stepDone: "Færdig", stepFailed: "Fejl", stepConnect: "Forbind til enhed", stepPartition: "Valider partitionstabel", stepDownload: "Download firmware", stepReadOtadata: "Læs otadata-partition", stepFlashApp: "Flash app-partition", stepFlashOtadata: "Flash otadata-partition", stepReset: "Nulstil enhed"
    },
    fi: {
      navHome: "Etusivu", navStats: "Tilastoeditori", darkMode: "Tumma tila", lightMode: "Vaalea tila", homeSubtitle: "Pieniä selaintyökaluja CPR-vCodex Steroidsille. Kaikki toimii paikallisesti selaimessasi.", latestFirmware: "Uusin firmware: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Tilastoeditori",
      flashEyebrow: "Selainpohjainen asennin", flashTitle: "Flashaa CPR-vCodex Steroids", flashSubtitle: "Asenna uusin CPR-vCodex Steroids-firmware Xteink X3/X4:ään Chromella tai Edgellä Web Serialin avulla. Se kirjoittaa passiivisen app-osion ja vaihtaa käynnistyksen siihen.",
      ...
      latestPackage: "Uusin firmwarepaketti", flashWarning: "Käytä omalla vastuulla. Mukautetun firmwaren flashaus voi epäonnistua, jos kaapeli irtoaa tai laite menettää virran.", unsupported: "Web Serial ei ole käytettävissä tässä selaimessa. Käytä Chromea tai Edgeä työpöytäkoneella tai lataa binääri käsin.", flashButton: "Flashaa CPR-vCodex Steroids-firmware", flashing: "Flashataan...", readyStatus: "Valmis. Flash-painike avaa selaimen sarjalaitteen valitsimen.", choosePort: "Valitse ESP32-C3-sarjaportti selaimen kehotteessa.", openingConnection: "Avataan bootloader-yhteyttä...", partitionOk: "Oletus CrossPoint/Xteink OTA -osiotaulu löytyi.", fetchingFirmware: "Ladataan firmwarepakettia...",
      firmwareDownloadFailed: "Firmwaren lataus epäonnistui", firmwareTooLarge: "Firmware on liian suuri app-osiolle: {size}.", firmwareTooSmall: "Firmware näyttää liian pieneltä. Epäilyttävää tiedostoa ei flashata.", currentBootTarget: "Nykyinen boot: {current}. Seuraava flash-kohde: {target}.", writingOffset: "Kirjoitetaan offsetiin {offset}...", partitionUnexpected: "Odottamaton osiomääritys. Tämä selainflasher tukee vain oletus CrossPoint/Xteink OTA -osiotaulua.", unknownFlashError: "Tuntematon flashausvirhe", flashComplete: "Flash valmis. Laitteen pitäisi käynnistyä CPR-vCodex Steroidsiin.", flashStopped: "Flash pysäytetty. Tarkista yllä oleva viesti ennen uutta yritystä.", downloadBin: "Lataa .bin", communityFlasher: "Yhteisöflasher", flashNote: "Automaattinen flasher käyttää tämän sivun kanssa julkaistua firmwarekopiota. Latauspainike käyttää GitHub-releasen assettia.", manualTitle: "Manuaalinen PlatformIO-flash", manualText: "Kehitysversioita varten kloonaa repo, aseta upload-portti ja käytä PlatformIO:ta.", stepPending: "Odottaa", stepRunning: "Käynnissä", stepDone: "Valmis", stepFailed: "Virhe", stepConnect: "Yhdistä laitteeseen", stepPartition: "Tarkista osiotaulu", stepDownload: "Lataa firmware", stepReadOtadata: "Lue otadata-osio", stepFlashApp: "Flashaa app-osio", stepFlashOtadata: "Flashaa otadata-osio", stepReset: "Nollaa laite"
    },
    pl: {
      navHome: "Start", navStats: "Edytor statystyk", darkMode: "Tryb ciemny", lightMode: "Tryb jasny", homeSubtitle: "Małe narzędzia przeglądarkowe dla CPR-vCodex Steroids. Wszystko działa lokalnie w przeglądarce.", latestFirmware: "Najnowszy firmware: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Edytor statystyk",
      flashEyebrow: "Instalator w przeglądarce", flashTitle: "Flash CPR-vCodex Steroids", flashSubtitle: "Zainstaluj najnowszy firmware CPR-vCodex Steroids na Xteink X3/X4 z Chrome lub Edge przez Web Serial. Zapisuje nieaktywną partycję app i przełącza na nią bootowanie.",
      ...
      latestPackage: "Najnowszy pakiet firmware", flashWarning: "Używasz na własne ryzyko. Flash niestandardowego firmware może się nie udać, jeśli kabel zostanie odłączony lub urządzenie straci zasilanie.", unsupported: "Web Serial nie jest dostępny w tej przeglądarce. Użyj Chrome lub Edge na komputerze desktopowym albo pobierz binarkę ręcznie.", flashButton: "Flashuj firmware CPR-vCodex Steroids", flashing: "Flashowanie...", readyStatus: "Gotowe. Kliknięcie Flash otworzy wybór urządzenia szeregowego w przeglądarce.", choosePort: "Wybierz port szeregowy ESP32-C3 w oknie przeglądarki.", openingConnection: "Otwieranie połączenia z bootloaderem...", partitionOk: "Znaleziono domyślną tablicę partycji OTA CrossPoint/Xteink.", fetchingFirmware: "Pobieranie pakietu firmware...",
      firmwareDownloadFailed: "Pobieranie firmware nie powiodło się", firmwareTooLarge: "Firmware jest za duży dla partycji app: {size}.", firmwareTooSmall: "Firmware wygląda na zbyt mały. Podejrzany plik nie zostanie flashowany.", currentBootTarget: "Aktualny boot: {current}. Następny cel flashowania: {target}.", writingOffset: "Zapis do offsetu {offset}...", partitionUnexpected: "Nieoczekiwana konfiguracja partycji. Ten flasher obsługuje tylko urządzenia z domyślną tabelą OTA CrossPoint/Xteink.", unknownFlashError: "Nieznany błąd flashowania", flashComplete: "Flash zakończony. Urządzenie powinno uruchomić CPR-vCodex Steroids.", flashStopped: "Flash zatrzymany. Sprawdź komunikat powyżej przed kolejną próbą.", downloadBin: "Pobierz .bin", communityFlasher: "Flasher społeczności", flashNote: "Automatyczny flasher używa kopii firmware opublikowanej z tą stroną. Przycisk pobierania używa assetu z release GitHub.", manualTitle: "Ręczny flash przez PlatformIO", manualText: "Dla buildów deweloperskich sklonuj repo, ustaw port uploadu i użyj PlatformIO.", stepPending: "Oczekuje", stepRunning: "W toku", stepDone: "Gotowe", stepFailed: "Błąd", stepConnect: "Połącz z urządzeniem", stepPartition: "Sprawdź tablicę partycji", stepDownload: "Pobierz firmware", stepReadOtadata: "Czytaj partycję otadata", stepFlashApp: "Flashuj partycję app", stepFlashOtadata: "Flashuj partycję otadata", stepReset: "Resetuj urządzenie"
    },
    ru: {
      navHome: "Главная", navStats: "Редактор статистики", darkMode: "Тёмный режим", lightMode: "Светлый режим", homeSubtitle: "Небольшие браузерные инструменты для CPR-vCodex Steroids. Всё работает локально в браузере.", latestFirmware: "Последняя прошивка: 1.5.0.23-CPR-vCodex Steroids-steroids", homeStats: "Редактор статистики",
      flashEyebrow: "Установщик в браузере", flashTitle: "Прошить CPR-vCodex Steroids", flashSubtitle: "Установите последнюю прошивку CPR-vCodex Steroids на Xteink X3/X4 из Chrome или Edge через Web Serial. Она записывает неактивный app-раздел и переключает загрузку на него.",
  ...
  const localizedTools = {
    be: {
      ...
      toolsSubtitle: "Браўзерныя інструменты для CPR-vCodex Steroids і карысныя знешнія сэрвісы для Xteink.",
      toolsStatsTitle: "Рэдактар статыстыкі чытання CPR-vCodex Steroids",
    ...
    ca: {
      navTools: "Eines",
      navSupport: "Suport",
      toolsSubtitle: "Eines de navegador per a CPR-vCodex Steroids i utilitats externes útils per al flux Xteink.",
      toolsStatsTitle: "Editor d'estadístiques de lectura CPR-vCodex Steroids",
    ...
    cs: {
      navTools: "Nástroje",
      navSupport: "Podpora",
      toolsSubtitle: "Nástroje v prohlížeči pro CPR-vCodex Steroids a užitečné externí služby pro Xteink.",
      toolsStatsTitle: "Editor statistik čtení CPR-vCodex Steroids",
    ...
    da: {
      navTools: "Værktøjer",
      navSupport: "Støtte",
      toolsSubtitle: "Browserværktøjer til CPR-vCodex Steroids og nyttige eksterne tjenester til Xteink.",
      toolsStatsTitle: "CPR-vCodex Steroids læsestatistik-editor",
    ...
    nl: {
      ...
      navSupport: "Steun",
      toolsSubtitle: "Browserhulpmiddelen voor CPR-vCodex Steroids en nuttige externe diensten voor Xteink.",
      toolsStatsTitle: "CPR-vCodex Steroids leesstatistieken-editor",
      ...
      navTools: "Työkalut",
      navSupport: "Tuki",
      toolsSubtitle: "Selaintyökaluja CPR-vCodex Steroidsille ja hyödyllisiä ulkoisia palveluja Xteinkille.",
      toolsStatsTitle: "CPR-vCodex Steroids-lukutilastojen editori",
    ...
    fr: {
      navTools: "Outils",
      navSupport: "Soutien",
      toolsSubtitle: "Outils de navigateur pour CPR-vCodex Steroids et services externes utiles pour Xteink.",
      toolsStatsTitle: "Éditeur de statistiques de lecture CPR-vCodex Steroids",
    ...
    de: {
      ...
      toolsSubtitle: "Browser-Werkzeuge für CPR-vCodex Steroids und nützliche externe Dienste für Xteink.",
      toolsStatsTitle: "CPR-vCodex Steroids Lesestatistik-Editor",
    ...
    hu: {
      ...
      toolsSubtitle: "Böngészős eszközök CPR-vCodex Steroidshez és hasznos külső szolgáltatások Xteinkhez.",
      toolsStatsTitle: "CPR-vCodex Steroids olvasási statisztika szerkesztő",
    ...
    it: {
      navTools: "Strumenti",
      navSupport: "Supporto",
      toolsSubtitle: "Strumenti browser per CPR-vCodex Steroids e servizi esterni utili per Xteink.",
      toolsStatsTitle: "Editor statistiche di lettura CPR-vCodex Steroids",
    ...
    kk: {
      navTools: "Құралдар",
      navSupport: "Қолдау",
      toolsSubtitle: "CPR-vCodex Steroids үшін браузер құралдары және Xteink үшін пайдалы сыртқы сервистер.",
      toolsStatsTitle: "CPR-vCodex Steroids оқу статистикасы редакторы",
    ...
    lt: {
      ...
      toolsSubtitle: "Naršyklės įrankiai CPR-vCodex Steroids ir naudingi išoriniai servisai Xteink.",
      toolsStatsTitle: "CPR-vCodex Steroids skaitymo statistikos redaktorius",
    ...
    pl: {
      navTools: "Narzędzia",
      navSupport: "Wesprzyj",
      toolsSubtitle: "Narzędzia przeglądarkowe dla CPR-vCodex Steroids i przydatne zewnętrzne usługi dla Xteink.",
      toolsStatsTitle: "Edytor statystyk czytania CPR-vCodex Steroids",
    ...
    pt: {
      ...
      navSupport: "Apoiar",
      toolsSubtitle: "Ferramentas de navegador para CPR-vCodex Steroids e serviços externos úteis para Xteink.",
      toolsStatsTitle: "Editor de estatísticas de leitura CPR-vCodex Steroids",
    ...
    ro: {
      navTools: "Unelte",
      navSupport: "Susține",
      toolsSubtitle: "Unelte în browser pentru CPR-vCodex Steroids și servicii externe utile pentru Xteink.",
      toolsStatsTitle: "Editor statistici de citire CPR-vCodex Steroids",
    ...
    ru: {
      ...
      toolsSubtitle: "Браузерные инструменты для CPR-vCodex Steroids и полезные внешние сервисы для Xteink.",
      toolsStatsTitle: "Редактор статистики чтения CPR-vCodex Steroids",
    ...
    si: {
      navTools: "Orodja",
      navSupport: "Podpora",
      toolsSubtitle: "Brskalniška orodja za CPR-vCodex Steroids in uporabne zunanje storitve za Xteink.",
      toolsStatsTitle: "Urejevalnik bralnih statistik CPR-vCodex Steroids",
    ...
    sv: {
      navTools: "Verktyg",
      navSupport: "Stöd",
      toolsSubtitle: "Webbläsarverktyg för CPR-vCodex Steroids och användbara externa tjänster för Xteink.",
      toolsStatsTitle: "CPR-vCodex Steroids lässtatistikredigerare",
    ...
    tr: {
      navTools: "Araçlar",
      navSupport: "Destek",
      toolsSubtitle: "CPR-vCodex Steroids için tarayıcı araçları ve Xteink için yararlı harici servisler.",
      toolsStatsTitle: "CPR-vCodex Steroids okuma istatistikleri düzenleyici",
    ...
    uk: {
      ...
      toolsSubtitle: "Браузерні інструменти для CPR-vCodex Steroids і корисні зовнішні сервіси для Xteink.",
      toolsStatsTitle: "Редактор статистики читання CPR-vCodex Steroids",
    ...
    vi: {
      navTools: "Công cụ",
      navSupport: "Ủng hộ",
      toolsSubtitle: "Công cụ trình duyệt cho CPR-vCodex Steroids và các dịch vụ ngoài hữu ích cho Xteink.",
      toolsStatsTitle: "Trình chỉnh sửa thống kê đọc CPR-vCodex Steroids",
  ...
  const localizedHomeCards = {
    en: {
      homeSubtitle: "Firmware, auto-flash and local browser tools for CPR-vCodex Steroids on Xteink X3/X4.",
      ...
      homeSupportBody: "Support CPR-vCodex Steroids development on Ko-fi."
    },
    es: {
      homeSubtitle: "Firmware, auto flash y herramientas locales de navegador para CPR-vCodex Steroids en Xteink X3/X4.",
      ...
      homeSupportBody: "Apoya el desarrollo de CPR-vCodex Steroids en Ko-fi."
    },
    ca: {
      homeSubtitle: "Firmware, flash automàtic i eines locals de navegador per a CPR-vCodex Steroids a Xteink X3/X4.",
      ...
      homeSupportBody: "Dona suport al desenvolupament de CPR-vCodex Steroids a Ko-fi."
    },
    fr: {
      homeSubtitle: "Firmware, flash automatique et outils locaux de navigateur pour CPR-vCodex Steroids sur Xteink X3/X4.",
      ...
      homeSupportBody: "Soutenez le développement de CPR-vCodex Steroids sur Ko-fi."
    },
    de: {
      homeSubtitle: "Firmware, Auto-Flash und lokale Browser-Werkzeuge für CPR-vCodex Steroids auf dem Xteink X3/X4.",
      ...
      homeSupportBody: "Unterstützen Sie die Entwicklung von CPR-vCodex Steroids auf Ko-fi."
    },
    it: {
      homeSubtitle: "Firmware, flash automatico e strumenti locali del browser per CPR-vCodex Steroids su Xteink X3/X4.",
      ...
      homeSupportBody: "Sostieni lo sviluppo di CPR-vCodex Steroids su Ko-fi."
    },
    pt: {
      homeSubtitle: "Firmware, flash automático e ferramentas locais de navegador para CPR-vCodex Steroids no Xteink X3/X4.",
      ...
      homeSupportBody: "Apoie o desenvolvimento do CPR-vCodex Steroids no Ko-fi."
    },
    nl: {
      homeSubtitle: "Firmware, auto-flash en lokale browserhulpmiddelen voor CPR-vCodex Steroids op Xteink X3/X4.",
      ...
      homeSupportBody: "Steun de ontwikkeling van CPR-vCodex Steroids op Ko-fi."
    },
    be: {
      homeSubtitle: "Прашыўка, аўта-flash і лакальныя браўзерныя інструменты для CPR-vCodex Steroids на Xteink X3/X4.",
      ...
      homeSupportBody: "Падтрымайце распрацоўку CPR-vCodex Steroids на Ko-fi."
    },
    cs: {
      homeSubtitle: "Firmware, automatický flash a lokální nástroje v prohlížeči pro CPR-vCodex Steroids na Xteink X3/X4.",
      ...
      homeSupportBody: "Podpořte vývoj CPR-vCodex Steroids na Ko-fi."
    },
    da: {
      homeSubtitle: "Firmware, auto-flash og lokale browserværktøjer til CPR-vCodex Steroids på Xteink X3/X4.",
      ...
      homeSupportBody: "Støt udviklingen af CPR-vCodex Steroids på Ko-fi."
    },
    fi: {
      homeSubtitle: "Firmware, automaattinen flash ja paikalliset selaintyökalut CPR-vCodex Steroidsille Xteink X3/X4:ssä.",
      ...
      homeSupportBody: "Tue CPR-vCodex Steroidsin kehitystä Ko-fissa."
    },
    hu: {
      homeSubtitle: "Firmware, automatikus flash és helyi böngészős eszközök CPR-vCodex Steroidshez Xteink X3/X4-en.",
      ...
      homeSupportBody: "Támogasd a CPR-vCodex Steroids fejlesztését Ko-fin."
    },
    kk: {
      homeSubtitle: "Xteink X3/X4 үшін CPR-vCodex Steroids firmware, авто-flash және жергілікті браузер құралдары.",
      ...
      homeSupportBody: "CPR-vCodex Steroids әзірлеуін Ko-fi арқылы қолдаңыз."
    },
    lt: {
      homeSubtitle: "Programinė įranga, automatinis flash ir vietiniai naršyklės įrankiai CPR-vCodex Steroids Xteink X3/X4.",
      ...
      homeSupportBody: "Paremkite CPR-vCodex Steroids kūrimą Ko-fi."
    },
    pl: {
      homeSubtitle: "Firmware, auto flash i lokalne narzędzia przeglądarkowe dla CPR-vCodex Steroids na Xteink X3/X4.",
      ...
      homeSupportBody: "Wesprzyj rozwój CPR-vCodex Steroids na Ko-fi."
    },
    ro: {
      homeSubtitle: "Firmware, flash automat și unelte locale de browser pentru CPR-vCodex Steroids pe Xteink X3/X4.",
      ...
      homeSupportBody: "Susține dezvoltarea CPR-vCodex Steroids pe Ko-fi."
    },
    ru: {
      homeSubtitle: "Прошивка, авто-flash и локальные браузерные инструменты для CPR-vCodex Steroids на Xteink X3/X4.",
      ...
      homeSupportBody: "Поддержите разработку CPR-vCodex Steroids на Ko-fi."
    },
    si: {
      homeSubtitle: "Firmware, samodejni flash in lokalna brskalniška orodja za CPR-vCodex Steroids na Xteink X3/X4.",
      ...
      homeSupportBody: "Podprite razvoj CPR-vCodex Steroids na Ko-fi."
    },
    sv: {
      homeSubtitle: "Firmware, auto flash och lokala webbläsarverktyg för CPR-vCodex Steroids på Xteink X3/X4.",
      ...
      homeSupportBody: "Stöd utvecklingen av CPR-vCodex Steroids på Ko-fi."
    },
    tr: {
      homeSubtitle: "Xteink X3/X4 üzerinde CPR-vCodex Steroids için firmware, otomatik flash ve yerel tarayıcı araçları.",
      ...
      homeSupportBody: "CPR-vCodex Steroids geliştirmesini Ko-fi üzerinde destekleyin."
    },
    uk: {
      homeSubtitle: "Прошивка, авто-flash і локальні браузерні інструменти для CPR-vCodex Steroids на Xteink X3/X4.",
      ...
      homeSupportBody: "Підтримайте розробку CPR-vCodex Steroids на Ko-fi."
    },
    vi: {
      homeSubtitle: "Firmware, auto flash và công cụ trình duyệt cục bộ cho CPR-vCodex Steroids trên Xteink X3/X4.",
      ...
      homeSupportBody: "Ủng hộ phát triển CPR-vCodex Steroids trên Ko-fi."
    }
  };
  ...
  const localizedTitles = Object.fromEntries(languages.map(([language]) => [language, "CPR-vCodex Steroids"]));
